...
<div  class=" text-center">
		...
		<div style="margin-left: 100px; margin-right:100px;">    
                        ...
                        <?php
                            ...
                            $regi = mysqli_query($conexion, "select  *from compra A where Not exists (select *from analisissensorial B where A.marca = B.codigo_sensorial)") or die("Problemas en el select:" . mysqli_error($conexion));
