...
<div class="container text-center">
		...
		<div style="margin-left: 100px; margin-right:100px;">    
                        ...
                        <?php
                            ...
                            $registros = mysqli_query($conexion, "select  *from secado A where Not exists (select * from resultadosecado B where B.codigo_resultado = A.codigo_secado)  ") or die("Problemas en el select:" . mysqli_error($conexion));
